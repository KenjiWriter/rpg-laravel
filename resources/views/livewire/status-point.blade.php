...
<label for="" style="margin-top: 20px; margin-right: 5px;">Vitality </label>{{ $user->vitality}} <blue>||</blue> (<green>HP</green> {{ App\Http\Controllers\FunctionsController::numConverter($user->health); }})<br>
<label for="" style="margin-top: 20px; margin-right: 5px;">Enduracne </label>{{ $user->endurance}} <blue>||</blue> (<green>Damage reduction</green> {{ $user->damage_reduction }}%)<br>
...
<label for="" style="margin-top: 20px; margin-right: 5px;">Vitality </label>{{ $user->vitality}} <button wire:click="vitality">&plus;</button> <blue>||</blue> (<green>Health</green> {{ App\Http\Controllers\FunctionsController::numConverter($user->health); }})<br>
<label for="" style="margin-top: 20px; margin-right: 5px;">Enduracne </label>{{ $user->endurance}} <button wire:click="endurance">&plus;</button> <blue>||</blue> (<green>Damage reduction</green> {{ $user->damage_reduction }}%)<br>
